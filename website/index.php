<?php
    ...
    $process_page_list = array('login_processing');
    $page = 'home';
    
    echo "<div id='masterbody'>";
    if (isset($_GET['page'])) { $page = $_GET['page']; }
    if (isset($_POST['login'])) { $page = $_POST['login']; }
    if (!in_array($page, $view_page_list) && !in_array($page, $process_page_list)) { die('Page not found.'); }
    else {
