    ...
    <body>
        <nav class="navbar fixed-top navbar-light navbar-expand-lg">
            <div class="container-fluid">
                ...
                <div class="d-flex d-flex-grow-1 justify-content-between collapse navbar-collapse"
                        ...
                        <ul class="d-flex flex-grow-1 navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link text" aria-current="page"
                                    href="http://localhost/website/index.php?page=home">Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text" aria-current="page"
                                    href="http://localhost/website/index.php?page=product">Shop</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="d-flex d-flex-col d-flex-grow-2 justify-content-center">
                        <ul class="d-flex flex-grow-1 navbar-nav me-auto my-1 mb-lg-0">
                            <img src="img/car-dealer-logo.png" alt="" width="200px" height="60px"
                    ...
                    <div class="d-flex d-flex-col d-flex-grow-1 justify-content-end">
                        <ul class="d-flex flex-grow-1 navbar-nav me-10 mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link text" aria-current="page"
                                    href="http://localhost/website/index.php?page=login">Login</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text" aria-current="page"
                                    href="http://localhost/website/index.php?page=register">Register</a>
                            </li>
                        </ul>
                    </div>
