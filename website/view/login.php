                    ...
                    <div class="card-body px-4 py-5 px-md-5">
                        <form name="loginForm" onsubmit="return validateForm()" method="post" action="" autocomplete="on">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="text" id="username" class="form-control" name="username" minlength="3"
                                    maxlength="25" placeholder="i.e. DucatiMeme933" required />
                            </div>
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="password" id="password" class="form-control" name="password" minlength="8"
                                    maxlength="50"
                                    title="Contain at least 8 characters with one uppercase, one lowercase, a number and a special character."
                                    placeholder="i.e. xS1jk@86tm" required />
                                <div id="message">
                            ...
                            <div class="d-flex justify-content-center mb-4">
                                <button type="submit" name="login" value="login_processing"
                                    class="btn btn-primary bt-lg btn-block ">SIGN IN</button>
                            </div>
