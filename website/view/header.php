        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse col order-lg-first justify-content-start">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link text" aria-current="page" href="http://localhost/index.php?page=home">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text" aria-current="page" href="http://localhost/index.php?page=product">Shop</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="collapse navbar-collapse col order-lg-last justify-content-end">
                <ul class="navbar-nav me-10 mb-2 mb-lg-0">
                    ...
                    <?php if (isset($_SESSION["userId"])) { ?>
                        <li class="nav-item">
                            <a class="nav-link text" aria-current="page" href="http://localhost/index.php?page=dashboard">Welcome, <?php echo $_SESSION["Display_name"] ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text" aria-current="page" href="http://localhost/index.php?page=logout">Logout</a>
                        </li>
                    <?php } else { ?>
                        <li class="nav-item">
                            <a class="nav-link text" aria-current="page" href="http://localhost/index.php?page=login">Login</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text" aria-current="page" href="http://localhost/index.php?page=register">Register</a>
                        </li>
                    <?php } ?>
                </ul>
            </div>
